...
const work: WorkItem[] = [
  {
    media: [
      { type: "image", src: p1.src },
      // Add screen recording videos for live project demos:
      // { type: "video", src: "/videos/luxe-apparel-demo.mp4", poster: p1 },
    ],
    title: "Luxe Apparel",
    category: "E-commerce / Shopify",
    result: "+218% revenue in 6 months",
  },
  {
    media: [
      { type: "image", src: p2.src },
      // { type: "video", src: "/videos/finpulse-demo.mp4", poster: p2 },
    ],
    title: "FinPulse",
    category: "FinTech Mobile App",
    result: "120K downloads, 4.8★ rating",
  },
  {
    media: [
      { type: "image", src: p3.src },
      // { type: "video", src: "/videos/salesforge-demo.mp4", poster: p3 },
    ],
  ...
  },
  {
    ...
    result: "12K active users in 90 days",
  },
];
